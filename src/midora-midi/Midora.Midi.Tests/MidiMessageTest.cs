...
{
    [Fact]
    public void ShouldCreateChannelMessagesCorrectly()
    {
    ...
    [Fact]
    public void ShouldWriteChannelMessagesCorrectly()
    {
        MidiMessage m1 = MidiMessage.ControlChange(4, 3, 127);
        MidiMessage m3 = MidiMessage.ProgramChange(2, 27);
        MidiMessage m4 = MidiMessage.PitchWheelChange(15, 3274);
    ...
    [Fact]
    public unsafe void ShouldWriteChannelMessagesCorrectly_Pointer()
    {
        MidiMessage m1 = MidiMessage.ControlChange(4, 3, 127);
        MidiMessage m3 = MidiMessage.ProgramChange(2, 27);
        MidiMessage m4 = MidiMessage.PitchWheelChange(15, 3274);
    ...
    [Fact]
    public void ShouldCreateSystemMessagesCorrectly()
    {
        MidiMessage s1 = MidiMessage.SongPositionPointer(6830);
        ...
        Assert.Equal(6830, s1.DataPositive14Bit);
    ...
    [Fact]
    public void ShouldWriteSystemMessagesCorrectly()
    {
        MidiMessage s1 = MidiMessage.SongPositionPointer(6830);
        MidiMessage s2 = MidiMessage.TuneRequest();
        MidiMessage s3 = MidiMessage.StartSystemExclusive();
        ...
        int len1 = s1.WriteTo(buffer);
        int len2 = s2.WriteTo(buffer[len1..]);
        int len3 = s3.WriteTo(buffer[(len1 + len2)..]);
        int len4 = s4.WriteTo(buffer, len1 + len2 + len3);
        int len5 = s5.WriteTo(buffer, len1 + len2 + len3 + len4);
        int len6 = s6.WriteTo(buffer, len1 + len2 + len3 + len4 + len5);
        int len7 = s7.WriteTo(buffer, len1 + len2 + len3 + len4 + len5 + len6);
        ...
        Assert.Equal(0b__1111_0010, buffer[0]);
        Assert.Equal(0b__0010_1110, buffer[1]);
        Assert.Equal(0b__0011_0101, buffer[2]);
        Assert.Equal(0b__1111_0110, buffer[3]);
        Assert.Equal(0b__1111_0000, buffer[4]);
        Assert.Equal(9, buffer[5]);
        Assert.Equal(32, buffer[6]);
        Assert.Equal(113, buffer[7]);
        Assert.Equal(0b__1111_0111, buffer[8]);
    }

    [Fact]
    public unsafe void ShouldWriteSystemMessagesCorrectly_Pointer()
    {
        MidiMessage s1 = MidiMessage.SongPositionPointer(6830);
        MidiMessage s2 = MidiMessage.TuneRequest();
        MidiMessage s3 = MidiMessage.StartSystemExclusive();
