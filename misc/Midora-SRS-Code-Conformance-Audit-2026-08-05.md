...
- `.midora` 已实现 v1 common/manifest schema、严格 manifest codec、protobuf descriptor-aware wire 校验和兼容基线测试；完整 ZIP、其余结构性文件 schema、迁移、安全保存、损坏隔离与 Project round-trip 尚未实现。
