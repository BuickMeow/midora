...
public sealed class PreviewCompilerTests
{
    ...
    public void EventInstrumentPreviewUsesTemporaryContextAndCursorTempo()
    {
        ...
        fixture.Project.Conductor.Tempos.Add(new TempoChange(480, 90m));
    ...
    public void SubVoicePreviewKeepsInstrumentContextButFiltersOutput()
    {
        ...
        fixture.Instrument.SubVoices[0].Events.Add(TemplateEvent.Note(0, 120, 60, 100));
        fixture.Instrument.SubVoices[1].Events.Add(TemplateEvent.Note(0, 120, 72, 90));
    ...
    public void SegmentPreviewUsesOnlySelectedSegmentAndProjectConductorRange()
    {
        ...
        Segment other = new() { ProjectStartTick = 1_200, LengthTicks = 480 };
        CompilerTestProject.AddNote(other, fixture.Instrument, 0, 120, 72);
        fixture.Track.Segments.Add(other);
        fixture.Project.Conductor.Tempos.Add(new TempoChange(240, 90m));
        fixture.Project.Conductor.Tempos.Add(new TempoChange(720, 140m));
