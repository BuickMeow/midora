...
/// <summary>
/// Avalonia port of <c>Midora.Desktop.BatchEditHelpDialog</c>. The help text is the same static
/// WPF content; item collections are plain records used as demo data for reflection bindings.
/// </summary>
public partial class BatchEditHelpDialog : Window
{
    ...
    public IReadOnlyList<BatchEditHelpExample> Examples { get; } =
    [
        new(
            "1",
            "BASIC",
