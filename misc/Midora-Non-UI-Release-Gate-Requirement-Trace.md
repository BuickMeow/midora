...
- 十个测试项目各自的 TRX；当前基线精确为 760 tests，全部 passed、零 failed、零 notExecuted/Skip。
...
结果：固定 BASS baseline 通过；六个 Release solution 0 warning / 0 error；生成 Native AOT Worker；10 个测试项目 760/760 passed、0 skipped。
