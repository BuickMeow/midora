...
- **未实施条件项 LC-T3 的全链紧凑 canonical/source 重写。** 本轮两类大场景的同日三次中位数已达到旧数组版 1.25 倍以内目标，不再为结构统一叠加更高风险的来源/所有权重构。全部 Source 字段仍完整保存。
...
- canonical 全字段大记录仍存在，LC-T3 没有实施；在更极端来源熵或更高展开量下仍可能成为热点。若实际验收仍慢，应依据新瓶颈继续，不回退到无界数组。
