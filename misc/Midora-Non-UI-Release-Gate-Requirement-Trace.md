...
- 十个测试项目各自的 TRX；当前基线精确为 845 tests，全部 passed、零 failed、零 notExecuted/Skip。
...
结果：固定 BASS baseline 通过；六个 Release solution 0 warning / 0 error；生成 Native AOT Worker；10 个测试项目 845/845 passed、0 skipped。最近一次完整产物位于 `artifacts/non-ui-release-gate-ffea5b4bc45045d1b02e7a2dc163540c/`，只用于本地验证且被 Git 排除。
