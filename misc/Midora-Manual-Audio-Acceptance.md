...
状态：2026-08-07 首轮已执行；存在听感失败和 Native AOT Worker 路径阻塞，待修复后复测
日期：2026-08-06
...
首轮摘要：M-AUD-001 通过；M-AUD-002/M-AUD-005 在第一、第三、第四和弦末尾出现音量突增；M-AUD-003/M-AUD-006 的实例边界可听间隔已确认符合当前示例构造；M-AUD-004～006 缺少终端技术指标；M-AUD-007～009、011～012 因 Console 仍传入 managed Worker `.dll` 而在正式播放前被保护门阻止；M-AUD-010 通过。后续不得覆盖首轮快照，只能追加复测记录。
...
人工结果只关闭对应的人耳/物理设备门，不替代 862 项自动测试、Native AOT 发布门或 Q-NUI-013 的第三方二进制许可放行。
